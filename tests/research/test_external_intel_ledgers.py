...
RENAMED at the 2026-08-09 merge. Both branches independently created
`tests/research/test_external_intelligence.py` testing DIFFERENT things: this file covers the
ledgers (video_intelligence, return_claims, competitor_coverage), the other covers the Codex
seat's `libs/research/external_intelligence` module. Keeping one and discarding the other on a
name collision would have silently deleted a working suite, so both survive under names that say
what they test.
