...
2026-07-31 (R0144): run_ci.py exits 0 on lock contention so an organ's routine gate is not failed
...
def test_puller_invokes_strict_and_guards_the_revert():
    ...
    # tree moved during its CI window (the 2026-07-31 destroyed-work class, R0143).
