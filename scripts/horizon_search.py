...
def main() -> None:
    ...
    print(
        "    (t deflated by sqrt(h) for overlapping windows; survivor needs >=2 same-sign "
        "neighbours)\n"
    )
    allres = {}
        ...
        json.dumps(
            {
                ...
                "results": {
                    k: [{"h": h, "ic": ic, "t": t} for h, ic, t in v] for k, v in allres.items()
                },
            },
            indent=1,
        ),
