...
n_eff / min_detectable_ic / powered. Anything killed BEFORE those existed is unexamined, not refuted.
...
CAUSES = {
    ...
    "wrong_sign":       (1, "Mostly dead. Sign-flipping is p-hacking; only revisit if a mechanism explains the sign."),
    ...
    "costs_killed_edge":(3, "RESURRECT-ABLE: re-test against the NEW measured cost model + 24h min-hold."),
    ...
    "no_edge_daily":    (5, "PRIME RESURRECTION: killed at DAILY horizon only. Horizon search is the exact remedy."),
    "insufficient":     (5, "PRIME RESURRECTION: underpowered. New harness reports n_eff/min_detectable_ic."),
    ...
    "wrong_orthogonality": (2, "Redundant with an existing sleeve; revisit only if that sleeve dies."),
    "redundant":        (1, "Duplicate of a live signal. Not independent evidence."),
    "insignificant":    (4, "RESURRECT-ABLE: direction was right but underpowered -- re-test at scale."),
}
...
def main() -> None:
    ...
    labels = {5: "PRIME (horizon/power remedy exists)", 4: "STRONG", 3: "RESURRECT-ABLE (regime/cost/breadth)",
