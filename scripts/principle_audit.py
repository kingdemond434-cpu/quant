...
PRINCIPLES = {
    ...
    "measurement_before_optimisation": ("measurement", "assume the data is lying",
                                        "measure the thing"),
    ...
    "bottleneck_first": ("bottleneck", "limiting factor"),
    ...
    "complexity_governance": ("replace an existing component", "measurable bottleneck",
                              "complexity"),
    ...
    "capacity_awareness": ("capacity", "scalable", "capital"),
    "kill_fast": ("kill", "reject", "falsif"),
}
