...
_MAP: dict[str, list[str]] = {
    ...
    "L1.6": [
        ...
        "check_gate_optimality",
        "run_mutation.py",
        "scripts/check_cohort_integrity.py",
    ...
    "L1.16": ["mechanism_board.py", "check_gate_optimality", "scripts/screen_carry_basis_path.py"],
    "L1.17": ["negative_knowledge.py", "check_findings_ratchet", "docs/graveyard.md"],
    "L1.18": ["tests/research/test_capacity_policy.py", "libs/research/capacity_policy.py"],
    "L1.18a": [
        "tests/research/test_capacity_policy.py",
    ...
    "L1.19": ["revalidate_clocks.py", "scripts/run_reality_gap.py", "check_data_decay"],
    ...
    "L1.25": [
        "check_gate_optimality",
        "check_rejection_shadow",
        "scripts/check_gate_reachability.py",
    ],
    ...
    "L2.9": [
        ...
        "check_idle_capability",
        "check_orphan_code",
    ],
    "L2.10": ["run_reality_gap.py", "check_data_decay"],
    "L2.8a": [
        "scripts/check_constitution_core.py",
        "tests/ops/test_lawful.py",
    ...
    "L1.28": [
        ...
        "tests/libs/test_constitution.py",
    ...
    "L1.29": ["scripts/check_calibration.py", "libs/self_improvement/forecast_calibration.py"],
    ...
    "L1.34": [
        ...
        "check_prompt_layer",
        "tests/research/test_frontier_mandate_controls.py",
    ],
    ...
    # L1.50-L1.56 were added after the original matrix. Bind them to existing executable
    # mechanisms so new laws cannot sit outside the same existence/execution audit as older laws.
    "L1.50": [
        "scripts/check_coverage_floors.py",
        "check_test_suite_collectable",
        "check_no_ceiling",
    ],
    "L1.51": ["check_llm_exhaustion", "libs/alpha_factory/research_budget.py"],
    "L1.52": ["check_evig_ranking", "check_under_exploration", "scripts/run_alpha_frontier.py"],
    "L1.53": [
        "check_fixers_not_watchers",
        "scripts/check_utilisation.py",
        "libs/research/funnel.py",
    ],
    "L1.54": ["scripts/check_utilisation.py", "libs/research/research_control.py"],
    "L1.55": [
        "check_under_exploration",
        "libs/research/search_strategy.py",
        "scripts/run_alpha_frontier.py",
    ],
    "L1.56": ["check_unwired_modules", "tests/libs/test_build_deferral.py"],
...
_FENCE_OWNERS: dict[str, str] = {
    ...
    # --- current audit surface. These checks post-date the original reverse map; leaving them
    # unclaimed makes the matrix fail in the opposite direction (unvoted enforcement complexity).
    "check_model_freshness": "L1.7",
    "check_meta_research": "L1.22",
    "check_llm_exhaustion": "L1.51",
    "check_dependency_drift": "L2.9",
    "check_naive_datetime": "L1.46",
    "check_test_suite_collectable": "L1.50",
    "check_triage_disposition": "L1.39",
    "check_dig_log_disposition": "L1.39",
    "check_scheduled_scripts": "L1.49",
    "check_no_ceiling": "L1.50",
    "check_governing_layer_live": "L2.0",
    "check_law_coverage": "L2.0",
    "check_evig_ranking": "L1.52",
    "check_fixers_not_watchers": "L1.53",
    "check_under_exploration": "L1.55",
    "check_coexistence": "L1.23",
    "check_asymmetry_ratchet": "L1.11",
    "check_data_decay": "L1.19",
    "check_unwired_modules": "L1.54",
    "check_silent_swallows_on_the_rails": "L1.23",
    "check_moat_screened": "L1.11",
}
...
def build() -> dict[str, Any]:
        ...
        rows.append(
            {
                ...
                "scheduled": _scheduled(live),
                "note": note,
            }
        )

    mapped_fences = {
        r.split(":")[0] for refs in _MAP.values() for r in refs if r.startswith("check_")
    }
    ...
    return {
        ...
        "broken_references": {
            r["principle"]: r["broken_references"] for r in rows if r["broken_references"]
        },
...
def main() -> int:
    ...
    if args.json:
        ...
        print(
            f"enforcement matrix: {m['counts']} over {m['n_principles']} principles / "
            f"{m['n_fences']} fences"
        )
        ...
        print(
            f"  fences with no governing principle: {n_orph}"
    ...
    return (
        1 if (m["unenforced"] or m["broken_references"] or m["fences_without_a_principle"]) else 0
    )
