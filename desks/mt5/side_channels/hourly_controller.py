...
from .research_economics import ResearchEconomicsTracker, generate_economics_report, auto_reallocate_budget
from .hypothesis_schema import HypothesisCard, Origin, Mechanism, MarketContext, Rule, Economics, Falsifier, Novelty, Costs
...
def run_forever(base_path: Path, interval_minutes: int = 60) -> None:
    ...
    print(f"Starting Hourly Survivor Acquisition System")
    print(f"Base path: {base_path}")
    print(f"Interval: {interval_minutes} minutes")
    print(f"Components: reservoir, gap_analyzer, counterfactual_lab, regime_engine, economics, recombination")
