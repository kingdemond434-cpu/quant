...
def costs_for(sym, meta, mult=1.0):
    # THE ONE SANCTIONED CONSTRUCTOR. The hand-rolled arithmetic this replaced carried both
    # documented unit bugs (gold spread in $/oz written into a per-lot field; commission never
    # converted to the account currency) -- Costs.from_symbol is where the fixes live, and a
    # test forbids the hand-roll from coming back.
