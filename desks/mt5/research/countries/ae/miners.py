"""The AE pack's own miners. Today: the structured data plane, which had no clock at all.
...
miners -- so the writer ran nowhere and AE_DATA_PLANE.json had never existed. The adapter lives in
