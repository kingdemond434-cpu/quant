...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("CACHING", "compute", "desks/mt5/research/experiment_cache.py",
    ...
    Capability("ENSEMBLES", "forecast", "desks/mt5/mt5desk/family_ensemble.py",
    ...
    Capability("GRAPH_MODELS", "forecast", "desks/mt5/research/cross_asset_graph.py",
    ...
    Capability("CAPACITY", "capital", "desks/mt5/research/capacity.py",
    ...
    Capability("MONITORING", "compute", "scripts/build_zentech_state.py",
