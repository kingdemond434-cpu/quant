"""inalpha adapter -- import probe only. factor timing and strategy-code evolution; machine-gated
experiments only. While the upstream is absent the capability is carried by
libs/research/alpha_frontier.py."""
...
WHY = "factor timing and strategy-code evolution; machine-gated experiments only"
REBUILT_BY = "libs/research/alpha_frontier.py"
