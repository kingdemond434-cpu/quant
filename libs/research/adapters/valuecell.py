"""valuecell adapter -- REJECTED_WITH_EVIDENCE for direct execution: no package and no mechanism
beyond orchestration. Every module tried is named with its import result, so the refusal is a
measurement rather than an absence. Cover: libs/research/arena.py."""
...
TRIED: tuple[str, ...] = (
    ...
    "an application framework around LLM agents",
)
WHY = "no package and no mechanism beyond orchestration"
