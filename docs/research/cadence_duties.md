# Generation due -- 2026-07-20T08:05Z (stage S0)
...
- LITERATURE DEEP-MINER (every 14d, UNCAPPED/exhaustive, dedicated quant-litminer.timer biweekly): execute docs/research/LITERATURE_SPEC.md -- inbox triage to MECHANISMS (never summaries), 2-level citation-chain digs, replication scans, coverage rotation; cards -> EV gate + pre-registration; mark done: last_lit_deepdive. Lockdown priorities own the cycle first.
