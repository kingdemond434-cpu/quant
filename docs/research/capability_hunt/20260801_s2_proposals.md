# CAPABILITY HUNT PROPOSALS 20260801 slot 2

LENS: DEAD-BRANCH / ZERO-CALLER -- find a function, flag or config knob nothing calls or passes. Built-never-wired is engineering already paid for returning zero (L2.9).
