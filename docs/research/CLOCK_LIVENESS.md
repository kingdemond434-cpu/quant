...
Measured 2026-09-23T09:22:44.322590+00:00 on **trading_box** (`vmi3571445`) over **489 forward clocks**. FROZEN **0 -> 0** this pass (ratchet floor 0).
...
|---|---:|---:|---:|---|---|
| `main` | 483 | 47 | 0 | MT5-Shadow (hourly, research/shadow_cycle.py) + leg enrol_clocks inside MT5-Dept-Forward (resident, every 10 min) | 2026-09-23T09:22:41 |
| `qquant` | 1 | 0 | 0 | MT5-QQuantShadow (every 30 min, research/qquant_shadow.py) | 2026-09-23T08:55:49 |
| `scalp` | 4 | 4 | 0 | MT5-Shadow (hourly) -> the scalp lane inside research/shadow_cycle.py | 2026-09-23T08:55:49 |
...
|---|---|---|---|---|---|
| `MT5-Shadow` | RUNNING_24X7 | 1 Hour(s), 0 Minute(s) | 9/23/2026 11:21:23  | 267009 | runs shadow_cycle -> shadow_forward, the main and scalp lanes |
| `MT5-QQuantShadow` | RUNNING_24X7 | 0 Hour(s), 30 Minute(s) | 9/23/2026 10:55:01  | 1 | runs qquant_shadow, the qquant lane |
| `MT5-Dept-Forward` | RUNNING_24X7 | 0 Hour(s), 10 Minute(s) | 9/23/2026 11:20:01  | -2147020576 | the forward department resident: legs enrol_clocks and clock_liveness |
