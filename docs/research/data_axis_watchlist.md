...
> **(1) THE REQUEST PARAMETER (new — OP-072).** `to=` is interpreted in **KST by Bithumb** and in
...
### 33. KR venue↔bank fiat-rail registry — the venue-ASYMMETRIC barrier regressor (R0299's missing input) — grade: **catalogued + one instance MEASURED; treatment count NOT yet enumerated** [§33: screened -> data/kr_venue_bank_rail.json]
