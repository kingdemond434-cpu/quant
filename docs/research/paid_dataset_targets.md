...
| Nansen | wallet labels, smart-money flows | OPEN -- hunt public label sets (dawsbot/eth-labels, Etherscan public tags, Dune spellbook label tables, OFAC/《public》lists) + own clustering heuristics |
...
_seeded 2026-07-26 with 18 vendors; grows every dig_
