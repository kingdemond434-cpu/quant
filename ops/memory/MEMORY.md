...
- ~~Crypto desk state~~ — **DELETED 2026-09-05.** That desk was retired on 2026-08-18 by standing principal order and its state note went with it. The live desk is `desks/mt5/`; its state is `desks/mt5/docs/MT5_DESK.md` + `MT5_DESK_STATE.json`. The crypto era's durable record is `docs/graveyard.md`, `docs/institutional_knowledge.md` and `docs/research/archive_crypto_era/`.
