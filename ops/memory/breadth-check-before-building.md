...
- The free-data layer is broad already: stablecoin on-chain reserves, hyperliquid cross-venue funding, cross-exchange dispersion, options VRP/DVOL, F&G, liquidations (forward). See [[crypto-desk-state]].
